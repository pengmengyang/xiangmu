...
public class Deal_consignee_bill_Activity extends BaseActivity implements OnClickListener{
	...
	private EditText consignee_scan_billway_et;//输入运单号
	private Button consignee_add_btn;//添加
	private Button consignee_scan_btn;//扫描
	...
	private TextView consignee_count_tv;//统计
	private String consigneeman;
	private final static int SCANNIN_GREQUEST_CODE = 1;
	private ProgressDialog progressDialog2;
	private Button deal_consignee_bill_submit_btn;//提交
	private TextView deal_consignee_scan_show_name;//显示收件员
	...
	private void initView() {
		...
		title_text_tv.setText("交收件单");
		
		progressDialog=ProgressDialog.show(Deal_consignee_bill_Activity.this, "温馨提示", "数据正在加载中,请稍后");
	...
	public void onClick(View v) {
		...
		case R.id.title_back_rl://点击返回
			finish();
			break;
		case R.id.consignee_add_btn://点击添加
			getData();
			break;
		case R.id.consignee_scan_btn://点击扫描
			scanInputWaybliiNumber();
			break;
		case R.id.deal_consignee_bill_spinner://点击查询
			progressDialog=ProgressDialog.show(Deal_consignee_bill_Activity.this, "温馨提示", "数据正在加载中,请稍后");
			/**请求得到所有员工*/
			requestGetData(v);
			break;
		case R.id.deal_consignee_bill_submit_btn://点击提交
			progressDialog2=ProgressDialog.show(Deal_consignee_bill_Activity.this,"温馨提示","数据正在提交中,请稍后");
			submitDataToSQL();
			break;
